...
public class menu {
	...
	private void initialize(String idUser) {
		...
		/**
		 * Botón de acceso a módulo de gestión de EMPLEADOS
		 */		
		...
		/**
		 * Botón de acceso a módulo de gestión de SEDES
		 */		
		...
		/**
		 * Botón de acceso a módulo de gestión de PAQUETES
		 */
		...
		/**
		 * Botón de acceso a módulo de INFORMES
		 */
